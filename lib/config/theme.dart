...
import 'package:heyy/config/sizes.dart';
...
class AppTheme extends DefaultTheme {
  ...
  @override
  TextStyle hwSubTitle1({Color? color, FontStyle? fontStyle}) =>
      handwritten(size: 18, fontWeight: FontWeight.w700, color: color, fontStyle: fontStyle);

  @override
  TextStyle hwTitle1({Color? color, FontStyle? fontStyle}) =>
      handwritten(size: 48, fontWeight: FontWeight.w700, color: color, fontStyle: fontStyle);

  @override
  TextStyle hwHero({Color? color, FontStyle? fontStyle}) =>
      handwritten(size: 96, fontWeight: FontWeight.w800, color: color, fontStyle: fontStyle);
}
